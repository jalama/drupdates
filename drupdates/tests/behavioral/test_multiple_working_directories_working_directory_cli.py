...
class TestMultipleWorkingDirectoriesWorkingDirectoryCLI(object):
    ...
    def test_frst_repo_updated(self):
        ...
        report_status = BehavioralUtils.check_repo_updated(self.test_directory, 'drupal', 'builds/test')
    ...
    def test_working_dir(self):
        ...
        build_dir = os.path.join(os.path.expanduser('~'), '.drupdates', 'builds', 'test')
